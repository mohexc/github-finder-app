...
class User extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <Link to='/' className='btn btn-light'>Back To Seatch</Link>
        ...
        <div className="card grid-2">
          ...
          <div>{ bio && (<Fragment><h3>Bio</h3><p>{ bio }</p></Fragment>) }
            <a href={ html_url } className='btn btn-dark my-1'>Visit Github Profit</a>
            <ul>
